...
var ailrSrceFrom               = propFlightControls.getNode("ailr_srce_from", 1);
var elevSrceFrom               = propFlightControls.getNode("elev_srce_from", 1);
...
##    click.setBoolValue(0);
    ...
    ailrSrceFrom.setValue("yoke");
    elevSrceFrom.setValue("yoke");
...
##
  ...
  if ( rollC3.getValue() ) { 
      ailrSrceFrom.setValue("CIII");
  } 
  elsif ( rollC2b.getValue() ) {
      ailrSrceFrom.setValue("CIIb");
  } 
  else {
      ailrSrceFrom.setValue("yoke");
  }
